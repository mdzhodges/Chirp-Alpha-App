...
class AlpacaAlgoTrading:
    ...
    def get_alpaca_algo_trading_credentials_dict(self) -> dict[str, tuple[str, str]]:
        ...
        alpaca_balanced_api_key: str = os.getenv(Constants.ALPACA_BALANCED_API_KEY, "")
        alpaca_balanced_api_key_secret: str = os.getenv(Constants.ALPACA_BALANCED_API_KEY_SECRET, "")
        ...
        alpaca_algo_trading_strategy_dict: dict[str, tuple[str, str]] = {
            ...
            Constants.BALANCED_STR: (alpaca_balanced_api_key, alpaca_balanced_api_key_secret),
